...
function ModalSubmit() {
    ...
    EntityNameVAR_For_Header = "Medall";
    document.getElementById("EntityHeader").textContent = EntityNameVAR_For_Header;

    var m = document.createElement("button");
    m.setAttribute("type", "button");
    m.setAttribute("class", "btn btn-default");
    m.setAttribute("id", "CheapestBtn");
    m.style.fontSize = "20px";
    m.style.color = "black";
    m.style.width = "30%";
    m.style.paddingTop = "1%";
    m.style.paddingBottom = "1%";
    m.style.borderRadius = "20px";
    m.style.border = "1px solid gray";
    m.setAttribute("onClick", "CheapestSelect()");
    myNode.appendChild(m);
    document.getElementById("CheapestBtn").textContent = "Rs. " + TotalCheap;

    var pp = document.createElement("BR");
    myNode.appendChild(pp);

    var app = document.createElement("BR");
    myNode.appendChild(app);
    ...
    var ee = document.createElement("TH");
    ee.textContent = "Modify";
    
    ee.style.textAlign = "center";
    document.getElementById("TR_Head_InvoiceTableMain").appendChild(ee);
                    //alert(CostIndexCheap);
    ...
    for (var i = 0; i < CartArray.length; i++) {
        ...
        btnDel.setAttribute("class", "btn btn-danger btn-sm delete");
        btnDel.setAttribute("onclick", "delrow(this)");


        document.getElementById(i).appendChild(btnDel);
    ...
    function SendSMS() {
        ...
        MessageText = "Thank You for your Order " + UsernameFromSession + ". TAT for your Tests would be 4 Hrs. For Further Assistance on the same, Please Call: 903921513. Thank You";

        Address = "http://roundsms.com/api/sendhttp.php?authkey=YTJkYTcxNTQ3MWY";
        MobileNo = "&mobiles=9035921513";
...
function delrow(btn) {
    ...
    var id = btn.id;
    //alert(id);
    //alert(CostIndexCheap[id]);
    CostIndexCheap.splice(btn.id, 1);
    EntityCheap.splice(btn.id, 1);
    CartArray.splice(btn.id,1);
